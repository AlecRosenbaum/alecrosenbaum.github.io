...
categories:
  - android truetime port-authority rss tasker flask python
---
---
layout: post
title:  "Passive Bus Arrival Android Notifications"
...
![Lock Screen]({{ site.url }}lock_screen_screenshot.png) ![Details]({{ site.url }}notification_screenshot.png)
...
![Task]({{ site.url }}task_screenshot.png) ![AutoNotification]({{ site.url }}autonotification_screenshot.png)

Then, just tie the task to a profile that activates near home and every few minutes, and you're good to go!

![Profile]({{ site.url }}profile_screenshot.png)
