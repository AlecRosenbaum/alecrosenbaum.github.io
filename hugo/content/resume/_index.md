...
### Senior Software Engineer (Backend) at [Close.com](https://www.close.com)
#### Sept 2019 - Present
...
* Customer-facing projects include [Zoom integration](https://close.com/zoom/), [User Groups](https://blog.close.com/user-groups/)
* Engaged with Open Source community by supporting [tasktiger](https://github.com/closeio/tasktiger), [sync-engine](https://github.com/closeio/sync-engine)
* Wrote a [technical blog post](https://engineering.close.com/posts/python-3) about close's migration to Python 3.
...
### Senior Software Engineer at [drchrono](https://www.drchrono.com/)
...
### Software Engineer (Intern) at [Formlabs](https://formlabs.com/)
...
* Projects included:
    ...
    - Deploy and develop web-based dashboards using [jupyter dashboards](https://github.com/jupyter/dashboards) for live data analytics
...
###  Engineering Data Analyst (Co-op) at [change2target](http://www.change2target.com/)
...
### Engineering Data Analyst (Co-op) at [BMW Manufacturing](https://www.bmwusfactory.com/)
...
### Research Assistant at [National University of Singapore](http://www.nus.edu.sg/)
#### Summer 2015
...
### Computer Engineer (Intern) at [DEKA](http://www.dekaresearch.com/)
#### Summer 2014
...
* Writeup available [here](/posts/truetime-rss-android/)

<br/>

Download [[pdf](/static/resume/Alec_Rosenbaum_Resume.pdf)]
